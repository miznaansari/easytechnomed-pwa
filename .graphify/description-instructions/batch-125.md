# Node Description Batch 126 of 149
...
- "print_reportpdfgenerator_formatdate": "formatDate()" | kind=code-symbol | source=lib/offline/print/reportPdfGenerator.js:L108 | neighbors=[reportPdfGenerator.js]
