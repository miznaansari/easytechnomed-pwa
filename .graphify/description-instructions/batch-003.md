# Node Description Batch 4 of 148
...
- "tests_testsclient": "testsClient.jsx" | kind=code-symbol | source=app/(customer)/(dashboard)/settings/tests/testsClient.jsx:L1 | neighbors=[252e194 e, 56f4d63 f, 7d8c494 fxed, 84a8ff2 full indexeddb based, 9e25c19 f, b0c8bf9 full indexeddb based]
...
- "component_showresultmobile": "showResultMobile.jsx" | kind=code-symbol | source=app/(customer)/(dashboard)/test-report/component/showResultMobile.jsx:L1 | neighbors=[252e194 e, 532b740 fixed, 53ca5c1 stable version 1, aae6bad fixed, showResult.jsx, getReferenceRange()]
- "dashboard_page": "page.js" | kind=code-symbol | source=app/(customer)/(dashboard)/dashboard/page.js:L1 | neighbors=[252e194 e, 9e25c19 f, cf2bb98 new, DashboardCharts.js, DepartmentDistributionChart(), ReferralChart()]
