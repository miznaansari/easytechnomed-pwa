...
## Corpus Check
- Large corpus: 369 files · ~550,258 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5948 nodes · 9028 edges · 124 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 5633 · calls: 2692 · MODIFIES: 383 · ON_BRANCH: 100 · PARENT_OF: 99 · imports: 42 · imports_from: 35 · method: 29 · inherits: 13 · implements: 2


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 369 · Candidates: 597
- Excluded: 0 untracked · 120965 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `9d71afc`
...
Cohesion: 0.02
Nodes (24): GET(), serializeData(), 252e194 e, TrackingContext, GET(), serializeData(), eslintConfig, config (+16 more)
...
Cohesion: 0.05
Nodes (69): metadata, outfit, viewport, main, 005eea6 f, 05ff307 2.0.3, 0afb0ac 2.0.19, 124b88b 3.0.13 (+61 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (23): 2b2534c f, 56f4d63 f, 6fcf015 f, 7d8c494 fxed, 84a8ff2 full indexeddb based, 9e25c19 f, 9f59247 expire token, cc4c427 1.1.26 (+15 more)
...
Cohesion: 0.06
Nodes (19): 026962b 1.1.33, 1064f6b 2.0.10, 2291b5b 2.0.2, 2ef3785 2.0.1, 3c7e66b f, 3f7f1b4 2.0.0, 532b740 fixed, 53ca5c1 stable version 1 (+11 more)
...
Cohesion: 0.07
Nodes (27): 1ba5187 2.0.17, 37ee548 f, 8b1f3d8 a, 905ef50 fixed, a14c9b8 2.0.14, bcee6c8 fi, cb86968 fixed, cfa3879 f (+19 more)
...
Cohesion: 0.23
Nodes (5): DepartmentDistributionChart(), ReferralChart(), RegistrationChart(), RevenueChart(), quickRanges
...
Cohesion: 0.33
Nodes (2): metadata, registerSchema

### Community 91 - "Community 91"
Cohesion: 0.47
Nodes (4): GET(), POST(), registrationSchema, serializeData()
...
- **Thin community `Community 66`** (1 nodes): `SyncManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `AppDatabase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `NetworkMonitor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (2 nodes): `metadata`, `registerSchema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 121`** (2 nodes): `prisma`, `{ PrismaClient }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (2 nodes): `formatDate()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (2 nodes): `POST()`, `PUT()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (2 nodes): `GET()`, `processTestParameters()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (2 nodes): `callGeminiModels()`, `POST()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_d()` connect `Community 1` to `Community 3`, `Community 4`, `Community 100`, `Community 101`, `Community 105`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `SyncManager` connect `Community 66` to `Community 9`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `AppDatabase` connect `Community 67` to `Community 9`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.01876759461995621 - nodes in this community are weakly interconnected._