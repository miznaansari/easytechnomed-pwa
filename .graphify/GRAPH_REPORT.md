...
## Corpus Check
- Large corpus: 366 files · ~542,206 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5908 nodes · 8928 edges · 127 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 5619 · calls: 2688 · MODIFIES: 354 · ON_BRANCH: 77 · PARENT_OF: 76 · imports: 39 · imports_from: 31 · method: 29 · inherits: 13 · implements: 2


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 366 · Candidates: 592
- Excluded: 0 untracked · 120668 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `462f542`
...
Cohesion: 0.05
Nodes (28): 2b2534c f, 56f4d63 f, 6fcf015 f, 7d8c494 fxed, 84a8ff2 full indexeddb based, 9f59247 expire token, cc4c427 1.1.26, d446d11 fixed code (+20 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (58): main, 026962b 1.1.33, 05ff307 2.0.3, 0afb0ac 2.0.19, 14ed805 3.0.0, 14fa292 f, 1ba5187 2.0.17, 2476fb6 2.0.9 (+50 more)
...
Cohesion: 0.06
Nodes (14): 1064f6b 2.0.10, 2291b5b 2.0.2, 532b740 fixed, 84807f4 1.1.27, aae6bad fixed, cf2bb98 new, isOutOfRange(), isQualitativeAbnormal() (+6 more)
...
Cohesion: 0.50
Nodes (3): auth, firebaseConfig, googleProvider
...
- **Thin community `Community 72`** (1 nodes): `NetworkMonitor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `metadata`, `registerSchema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 121`** (2 nodes): `prisma`, `{ PrismaClient }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (2 nodes): `prisma`, `{ PrismaClient }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 125`** (2 nodes): `prisma`, `{ PrismaClient }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (2 nodes): `formatDate()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (2 nodes): `POST()`, `PUT()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (2 nodes): `GET()`, `processTestParameters()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (2 nodes): `callGeminiModels()`, `POST()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
