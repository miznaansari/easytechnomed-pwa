...
## Corpus Check
- Large corpus: 378 files · ~556,492 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
...
- Excluded: 2 untracked · 121671 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `36209a9`
...
Cohesion: 0.23
Nodes (6): RegistrationChart(), DepartmentDistributionChart(), quickRanges, 6812ab9 new ui dashboard, RevenueChart(), ReferralChart()

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (38): filter, indianStatesMap, indianCities, COMMON_LAB_UNITS, isQualitativeAbnormal(), isOutOfRange(), isQualitativeAbnormal(), isOutOfRange() (+30 more)

### Community 40 - "Community 40"
Cohesion: 0.12
Nodes (14): isLikelyMobile(), loginSchema, CustomerLoginPage(), metadata, theme, 1ba5187 2.0.17, 37ee548 f, 9e25c19 f (+6 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (24): callGemini(), POST(), serializeData(), GET(), serializeData(), GET(), TrackingContext, Loader() (+16 more)
...
Cohesion: 0.07
Nodes (10): DEFAULT_INITIAL_CHANGES, DEFAULT_OFFLINE_ADMIN, saveAuthenticatedSession(), getOrCreateOfflineSession(), getCachedSession(), isLocalSessionValid(), 4d7570f fixed, 5ff2734 2.0.11 (+2 more)
...
Cohesion: 0.05
Nodes (71): PRECACHE_ROUTES, 005eea6 f, 026962b 1.1.33, 05ff307 2.0.3, 0afb0ac 2.0.19, 124b88b 3.0.13, 14ed805 3.0.0, 14fa292 f (+63 more)
...
- **Thin community `Community 105`** (2 nodes): `serializeData()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (2 nodes): `processTestParameters()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Should `Community 8` be split into smaller, more focused modules?**
  _Cohesion score 0.037849944008958566 - nodes in this community are weakly interconnected._
- **Should `Community 40` be split into smaller, more focused modules?**
