...
export const MODEL_REGISTRY = {
  ...
  workspacePdf: {
    ...
    serializePost: (item) => item,
    serializePut: (item) => item,
    extractServerRecords: (data) => (data.pdfSetting || data.pdfConfig || data.settings ? [data.pdfSetting || data.pdfConfig || data.settings] : []),
    extractCreatedRecord: (data) => data.pdfSetting || data.pdfConfig || data.settings || data,
  },
