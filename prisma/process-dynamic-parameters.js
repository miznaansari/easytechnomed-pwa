  ...
  for (const test of unprocessedTests) {
    ...
    if (nameLower.includes("cbc") || nameLower.includes("complete blood count") || nameLower.includes("hemogram")) {
      parametersToCreate.push(
        ...
        { testId: test.id, name: "RBC COUNT (Red Blood Cells)", minValMale: 4.0, maxValMale: 6.5, normalRangeMale: "4.0 - 6.5", minValFemale: 4.0, maxValFemale: 6.5, normalRangeFemale: "4.0 - 6.5", minValBaby: 3.8, maxValBaby: 5.2, normalRangeBaby: "3.8-5.2", normalRangeDefault: "4.0 - 6.5", unit: "10^6/µL", order: 2 },
        ...
        { testId: test.id, name: "4.Monocytes", minValMale: 0, maxValMale: 6, normalRangeMale: "0 - 6", minValFemale: 0, maxValFemale: 6, normalRangeFemale: "0 - 6", minValBaby: 0, maxValBaby: 6, normalRangeBaby: "0 - 6", normalRangeDefault: "0 - 6", unit: "%", order: 7 },
        { testId: test.id, name: "5.Basophil", minValMale: 0, maxValMale: 1, normalRangeMale: "0 - 1", minValFemale: 0, maxValFemale: 1, normalRangeFemale: "0 - 1", minValBaby: 0, maxValBaby: 1, normalRangeBaby: "0 - 1", normalRangeDefault: "0 - 1", unit: "%", order: 8 },
        { testId: test.id, name: "Haemoglobin", minValMale: 13.0, maxValMale: 17.0, normalRangeMale: "13.0-17.0", minValFemale: 12.0, maxValFemale: 15.0, normalRangeFemale: "12.0-15.0", minValBaby: 11.0, maxValBaby: 14.0, normalRangeBaby: "11.0-14.0", normalRangeDefault: "12.0-16.0", unit: "g/dL", order: 9 },
        { testId: test.id, name: "PCV (Haematocrit)", minValMale: 42, maxValMale: 52, normalRangeMale: "42 - 52", minValFemale: 37, maxValFemale: 47, normalRangeFemale: "37 - 47", minValBaby: 35, maxValBaby: 45, normalRangeBaby: "35 - 45", normalRangeDefault: "42 - 52", unit: "%", order: 10 },
        { testId: test.id, name: "MCV", minValMale: 82, maxValMale: 98, normalRangeMale: "82-98", minValFemale: 82, maxValFemale: 98, normalRangeFemale: "82-98", minValBaby: 75, maxValBaby: 95, normalRangeBaby: "75-95", normalRangeDefault: "82-98", unit: "fl", order: 11 },
        { testId: test.id, name: "MCH", minValMale: 27, maxValMale: 32, normalRangeMale: "27-32", minValFemale: 27, maxValFemale: 32, normalRangeFemale: "27-32", minValBaby: 24, maxValBaby: 30, normalRangeBaby: "24-30", normalRangeDefault: "27-32", unit: "pg", order: 12 },
        { testId: test.id, name: "MCHC", minValMale: 32, maxValMale: 36, normalRangeMale: "32-36", minValFemale: 32, maxValFemale: 36, normalRangeFemale: "32-36", minValBaby: 31, maxValBaby: 35, normalRangeBaby: "31-35", normalRangeDefault: "32-36", unit: "g/dL", order: 13 },
        { testId: test.id, name: "Red Cell Distribution Width (RDW)-CV", minValMale: 11.0, maxValMale: 16.0, normalRangeMale: "11.0-16.0", minValFemale: 11.0, maxValFemale: 16.0, normalRangeFemale: "11.0-16.0", minValBaby: 11.5, maxValBaby: 16.5, normalRangeBaby: "11.5-16.5", normalRangeDefault: "11.0-16.0", unit: "%", order: 14 },
        { testId: test.id, name: "Red Cell Distribution Width (RDW)-SD", minValMale: 35, maxValMale: 56, normalRangeMale: "35 - 56", minValFemale: 35, maxValFemale: 56, normalRangeFemale: "35 - 56", minValBaby: 35, maxValBaby: 56, normalRangeBaby: "35 - 56", normalRangeDefault: "35 - 56", unit: "fl", order: 15 },
        { testId: test.id, name: "MPV", minValMale: 6.5, maxValMale: 12.0, normalRangeMale: "6.5 - 12", minValFemale: 6.5, maxValFemale: 12.0, normalRangeFemale: "6.5 - 12", minValBaby: 6.5, maxValBaby: 12.0, normalRangeBaby: "6.5 - 12", normalRangeDefault: "6.5 - 12", unit: "fl", order: 16 },
        { testId: test.id, name: "PDW", minValMale: 9.0, maxValMale: 17.0, normalRangeMale: "9 - 17", minValFemale: 9.0, maxValFemale: 17.0, normalRangeFemale: "9 - 17", minValBaby: 9.0, maxValBaby: 17.0, normalRangeBaby: "9 - 17", normalRangeDefault: "9 - 17", unit: "fl", order: 17 },
        { testId: test.id, name: "PCT", minValMale: 0.108, maxValMale: 0.282, normalRangeMale: "0.108 - 0.282", minValFemale: 0.108, maxValFemale: 0.282, normalRangeFemale: "0.108 - 0.282", minValBaby: 0.108, maxValBaby: 0.282, normalRangeBaby: "0.108 - 0.282", normalRangeDefault: "0.108 - 0.282", unit: "%", order: 18 }
      );
      ...
      parametersToCreate.push(
        ...
        { testId: test.id, name: "Serum Uric Acid", minValMale: 3.4, maxValMale: 7.0, normalRangeMale: "3.4-7.0", minValFemale: 2.4, maxValFemale: 6.0, normalRangeFemale: "2.4-6.0", minValBaby: 2.0, maxValBaby: 5.5, normalRangeBaby: "2.0-5.5", normalRangeDefault: "3.4-7.0", unit: "mg/dL", order: 3 },
        ...
        { testId: test.id, name: "Urea / Creatinine Ratio", minValMale: null, maxValMale: null, normalRangeMale: null, minValFemale: null, maxValFemale: null, normalRangeFemale: null, minValBaby: null, maxValBaby: null, normalRangeBaby: null, normalRangeDefault: "-NA-", unit: "ratio", order: 9 }
      );
...
async function main() {
  console.log("Resetting database test parameters flags...");
  await prisma.testParameter.deleteMany({});
  await prisma.test.updateMany({ data: { isProcessed: false } });
  
  console.log("Starting clinical parameters processing...");
  const count = await processTestParameters();
  console.log(`Completed dynamic parameter processing for ${count} tests!`);
}
